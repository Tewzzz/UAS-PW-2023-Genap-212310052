...
<div class="col-md-12 text-center">
    <h1 class="mt-3 fw-bold">Create New Post Culinary</h1>
</div>
<div class="row">
    <div class="col-md-2">
    ...
    <div class="d-flex col-md-8 mb-3 justify-content-center">
        <div class="col-md-10 mt-3">
            <div class="card shadow ">
                <form method="post" action="/admin/kuliner" enctype="multipart/form-data" class="p-2">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control description" name="deskripsi" required value="{{ old('deskripsi')}}"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Harga</label>
                        <input type="number" name="harga" class="form-control price @error('harga') is-invalid @enderror" placeholder="IDR" required value="{{ old('harga')}}">
                        @error('harga')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
