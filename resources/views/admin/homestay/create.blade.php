...
<div class="col-md-12 text-center">
    <h1 class="mt-3 fw-bold">Create New Post Homestay</h1>
</div>
<div class="row">
    <div class="col-md-2">
    ...
    <div class="d-flex col-md-8 mb-3 justify-content-center">
        <div class="col-md-10 mt-3">
            <div class="card shadow ">
                ...
                <form action="/admin/homestay" method="post" enctype="multipart/form-data" class="p-2">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control price @error('harga') is-invalid @enderror" name="harga" placeholder="IDR" required value="{{ old('harga')}}">
                        @error('harga')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="max_pax" placeholder="Pax">
                    </div>
                    <div class="mb-3">
